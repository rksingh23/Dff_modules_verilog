...
vlog dff_modules.v
vlog -work dff_modules_tb.v

# Loads a new design into the simulator
vsim -gui -novopt work.dff_async_high_low_tb work.dff_async_low_low_tb work.dff_sync_high_high_tb work.dff_sync_low_high_tb
...
add wave -position insertpoint sim:/dff_async_low_low_tb/*
add wave -position insertpoint sim:/dff_sync_high_high_tb/*
add wave -position insertpoint sim:/dff_async_high_low_tb/*
add wave -position insertpoint sim:/dff_sync_low_high_tb/*
